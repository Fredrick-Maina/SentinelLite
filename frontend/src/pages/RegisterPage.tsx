    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      <div className="glass-card w-full max-w-md p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-slate-100">Register SentinelLite Account</h2>
          <p className="text-sm text-slate-400">Start monitoring your security logs</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-lg pl-10 pr-4 py-2 text-slate-100 focus:outline-none focus:border-emerald-500"
              />
            </div>
          </div>

          <div>
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Business / Org Name</label>
            <div className="relative">
        ...
        <div className="text-center text-sm text-slate-400 pt-2 border-t border-slate-800">
          Already registered?{' '}
          <button onClick={onNavigateLogin} className="text-emerald-400 hover:underline font-semibold">
            Sign In
          </button>
        </div>
      </div>
